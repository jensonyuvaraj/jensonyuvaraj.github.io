...
try{
  ...
  const states={focus:{label:'Deep focus',cam:[0,.3,7.8],world:[0,0,0],monitor:acid,orbit:.18},build:{label:'Building systems',cam:[.35,.25,7.15],world:[-.1,.08,0],monitor:blue,orbit:.7},think:{label:'Connecting ideas',cam:[-.45,.62,6.75],world:[.18,-.02,0],monitor:acid,orbit:1},play:{label:'Signal sprint',cam:[.18,.28,7.05],world:[-.05,.08,0],monitor:acid,orbit:.82},connect:{label:'Open to connect',cam:[0,.4,7.35],world:[0,.12,0],monitor:blue,orbit:.45}};
